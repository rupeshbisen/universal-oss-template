...
1. **Report to Security Team**: Send a detailed report to [security@example.com](mailto:security@example.com)
...
* **Maintainers**: [@project-maintainers](https://github.com/your-username)
